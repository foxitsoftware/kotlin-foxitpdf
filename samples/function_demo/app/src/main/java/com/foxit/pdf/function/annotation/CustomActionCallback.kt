...
internal class CustomActionCallback : ActionCallback() {
    ...
    override fun response(question: String, title: String, default_value: String, label: String, is_password: Boolean): String {
        return ""
    }
    ...
    override fun print(document: PDFDoc, is_ui: Boolean, page_range: Range, is_silent: Boolean, is_shrunk_to_fit: Boolean,
                       is_printed_as_image: Boolean, is_reversed: Boolean, is_to_print_annots: Boolean): Boolean {
        return false
    }
    ...
    override fun getIdentityProperties(): IdentityProperties {
        return IdentityProperties("foxitsoftware", "simple_demo@foxitsoftware.cn", "simple demo", "Simple")
    }
    ...
    override fun mailData(data: Any, is_ui: Boolean, to: String, subject: String, cc: String, bcc: String, message: String): Boolean {
        return false
    }
